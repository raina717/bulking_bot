...
- `/minggu` — Get a weekly progress summary (average weight & intake vs target) along with suggestions to adjust your caloric surplus.
...
/berat 65.5
/olahraga 350 5k run
/makan 450 35        (Calories & protein from a single meal, can be called multiple times a day)
/sisa                (Check remaining calorie/protein budget for today)
/minggu              (Check weekly progress & surplus adjustment advice)
```
...
2. `/profile` — Fill in your body metrics & target (e.g., gain 5 kg in 8 weeks).
3. `/kalori` — View your daily calorie & protein targets.
...
- The estimation of **1 kg weight gain ≈ 7700 kcal** is a rough mixed-tissue estimate (muscle + fat). Pure muscle gain actually requires less energy, but since 100% muscle gain is unrealistic, 7700 kcal/kg serves as a standard conservative estimate.
...
- The **protein target (2g/kg body weight)** falls within the optimal range (1.6–2.2 g/kg) recommended by the ISSN for individuals undergoing bulking/strength training.
